/**
 * =========================================================================================
 * Project     : Arduino Uno Motorcycle Lean Angle & Dynamic Traction Slip Warning
 * Platform    : Arduino Uno / ATmega328P
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : Motorcycle instrumentation system measuring lean angle up to 60 degrees via fused IMU filter, detecting cornering wheel slip differential and warning rider.
 * =========================================================================================
 */
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" Arduino Uno Motorcycle Lean Angle & Dynamic Traction Slip Warning"));
